...
-- binary version: release TRUNK+GPRS P built Oct 16 2013 revUnversioned directory 
--
...
INSERT OR IGNORE INTO "CONFIG" VALUES('CLI.SocketPath','/var/run/command2',0,0,'Path for Unix domain datagram socket used for the OpenBTS console interface.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('Control.Reporting.PhysStatusTable','/var/run/ChannelTable2.db',1,0,'File path for channel status reporting database.  Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('Control.Reporting.StatsTable','/var/log/OpenBTSStats2.db',1,0,'File path for statistics reporting database.  Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('Control.Reporting.TMSITable','/var/run/TMSITable2.db',1,0,'File path for TMSITable database.  Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('Control.Reporting.TransactionTable','/var/run/TransactionTable2.db',1,0,'File path for transaction table database.  Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('Control.SMSCB.Table','',1,0,'File path for SMSCB scheduling database.  By default, this feature is disabled.  To enable, specify a file path for the database e.g. /var/run/SMSCB2.db.  To disable again, execute "unconfig Control.SMSCB.Table".  Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('Control.TestCall.LocalPort','24030',0,0,'Port number part of source for L3 payloads received from the handset in fuzzing interface.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('Control.TestCall.RemotePort','24031',0,0,'Port number part of destination for L3 payloads received from the handset in fuzzing interface.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GPRS.SGSN.port','1921',0,0,'Port number of the SGSN required for GPRS service.  This must match the port specified in the SGSN config file, currently osmo_sgsn.cfg.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Radio.RxGain','0',1,0,'Receiver gain setting in dB.  Ideal value is dictated by the hardware; 47 dB for RAD1, less for USRPs  This database parameter is static but the receiver gain can be modified in real time with the CLI rxgain command.  Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('Peering.NeighborTable.Path','/var/run/NeighborTable2.db',1,0,'File path for neighbor information database.  Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('Peering.Port','16002',1,0,'The UDP port used by the peer interface for handover.  Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('RTP.Start','18484',1,0,'Base of RTP port pool.  Pool is RTP.Start to RTP.Range-1.  Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('SIP.Local.Port','5072',1,0,'IP port that OpenBTS uses for its SIP interface.  Static.');
